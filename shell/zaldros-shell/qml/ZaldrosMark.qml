...
// The Zaldros start mark. Deliberately NOT a four-pane Windows logo: that shape is Microsoft's
// trademark. Ours is three stacked slabs — "zaldros" — in the same 24 px optical size, so the
