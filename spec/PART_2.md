# RAVEN OS — MASTER SPECIFICATION — PART 2/5 — WINDOWS-LIKE DESKTOP & USER EXPERIENCE
...
4. START MENU (Raven Start) — pinned apps, all installed apps, recent items, search, user profile, power, settings, system shortcuts, keyboard nav. Must open fast; no heavy always-on indexer unless justified.
...
18. THEMING — unified Raven design system: typography, spacing, colours, icons, borders, shadows, transparency, controls, menus, dialogs, animations. No mixed visual systems.
