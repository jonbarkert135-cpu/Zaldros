...
| Window titlebars (real apps) | **ours** — `assets/themes/aurorae/Zaldros{,-Dark}` | Aurorae SVG theme generated by `tools/theme/make_aurorae.py` | KWin | **COMPLETE (awaiting boot evidence)** | 4.0 | 32 px title bar, 46 × 32 caption buttons, 8 px corners, from win11-reference.json |
