...
| R3 | Name collision with the existing Bedrock Linux meta-distribution (bedrocklinux.org) | Brand confusion, SEO | High | Flagged to the owner; decide final public name before any release |
