...
| R3 | Name collision with the existing Zaldros OS meta-distribution (zaldroslinux.org) | Brand confusion, SEO | High | Flagged to the owner; decide final public name before any release |
...
| R6 | Performance targets unmet on old hardware | Missed goal | Medium | Zaldros Legacy profile; measurement contract on every milestone |
