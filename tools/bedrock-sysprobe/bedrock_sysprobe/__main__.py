"""CLI entry point: python -m bedrock_sysprobe [--json|--markdown] [-o FILE]"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="bedrock-sysprobe", description=__doc__)
    ...
    if not services:
        print("bedrock-sysprobe: no systemd services found (is this a systemd system?)", file=sys.stderr)
        return 1
