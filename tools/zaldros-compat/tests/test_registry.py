...
from zaldros_compat.registry import (  # noqa: E402
    Entry,
    Evidence,
    ValidationError,
    load,
...
from zaldros_compat.__main__ import main  # noqa: E402

DATA = os.path.join(os.path.dirname(__file__), "..", "data")

GOOD_EVIDENCE = {
    "date": "2026-08-23",
    "build": "zaldros-0.1.0-20260823",
    "tester": "ci",
...
def test_evidence_must_be_complete_and_dated():
    ...
    assert entry.evidence[0].build == "zaldros-0.1.0-20260823"
