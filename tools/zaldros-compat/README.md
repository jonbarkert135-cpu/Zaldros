...
Keeps Zaldros OS honest about what works. Two registries live in `data/`:
...
```bash
python -m zaldros_compat --check            # CI gate
python -m zaldros_compat --report hardware  # markdown matrix for the docs/Store
```
