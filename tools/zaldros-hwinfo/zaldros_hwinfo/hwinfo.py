...
Backend for Zaldros Device Manager (spec PART 3 §8) and Zaldros System Information (§13).
...
def to_markdown(inventory: Inventory) -> str:
    ...
    lines = [
        "# Zaldros Linux — system & device inventory",
        "",
        "## System",
    ...
    lines += [
        ...
        "reported as `unknown` — Zaldros never fabricates hardware information (spec PART 3 §21).",
    ]
    return "\n".join(lines) + "\n"
