"""CLI:
    ...
    python -m zaldros_bench collect --label baseline -o baseline.json
    python -m zaldros_bench compare baseline.json candidate.json
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="zaldros-bench", description=__doc__)
